...
SELECT * FROM EMPLOYEES
WHERE AGE < ALL (SELECT AGE FROM EMPLOYEES
				WHERE DEPARTMENT = "IT");
...
-- EXITS
SELECT * FROM EMPLOYEES
WHERE EXISTS (SELECT * FROM EMPLOYEES WHERE CITY ="CHENNAI");

SELECT * FROM EMPLOYEES E1
WHERE EXISTS (SELECT * FROM EMPLOYEES E2
WHERE E1.DEPARTMENT = E2.DEPARTMENT AND E2.AGE > 30);
...
SELECT * FROM EMPLOYEES E1
WHERE AGE > (SELECT AVG(AGE) FROM EMPLOYEES E2
