...
SELECT NAME,SALARY,
	(SELECT MAX(SALARY) FROM EMPLOYEES) - SALARY AS DIFF_RESULT
FROM EMPLOYEES;

SELECT NAME,SALARY,
	SALARY - (SELECT AVG(SALARY) FROM EMPLOYEES) AS AVG_RESULT
FROM EMPLOYEES;
...
SELECT * FROM EMPLOYEES;
SELECT CITY FROM EMPLOYEES WHERE EMP_ID = 1;
...
SELECT * FROM EMPLOYEES WHERE NAME = "EVE";
SELECT * FROM EMPLOYEES
WHERE SALARY > (SELECT SALARY FROM EMPLOYEES WHERE NAME = "EVE");
...
SELECT * FROM EMPLOYEES
WHERE CITY = (SELECT CITY FROM EMPLOYEES WHERE EMP_ID = 5);

SELECT * FROM EMPLOYEES
WHERE AGE > (SELECT MIN(AGE) FROM EMPLOYEES WHERE DEPARTMENT = "FINANCE");
